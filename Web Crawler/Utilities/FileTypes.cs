...
namespace Web_Crawler.Utilities
{
    class FileTypes
    {
        ...
        public static List<string> Video { get; } = new List<string>() { "M2TS", "MP4", "MKV", "AVI", "MPEG", "MPG", "MOV", "M4V", "WMV", "FLV" };
        ...
        public static List<string> Other { get; } = new List<string>() { "DAT", "INI", "ASM", "MD", "DLL", "SFV", "CPK", "RPT", "CAB", "BAT", "URL", "CF1", "CF2", "INF", "NFO", "MQ4", "NDS", "JSP", "GG", "SWF", "PS", "RTF", "BAS", "CC", "C", "CPP", "CXX", "H", "HPP", "CS", "JAVA", "PY", "PL", "PHP", "DB", "HTM", "HTML", "ASPX", "XML", "TXT", "SQL", "CSV", "PSD", "GZ", "BIN", "LOG", "CUE", "PAR", "PAR2", "PYK", "PK3", "PK4", "SKB", "IMG", "HGZ", "AI", "OTF", "TTF", "CSS", "PLS", "Z64" };
    }
}
