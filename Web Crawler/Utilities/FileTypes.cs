...
namespace Web_Crawler.Utilities
{
    class FileTypes
    {
        ...
        public static List<string> Other { get; } = new List<string>() { "TGZ", "DIZ", "LHA", "PPT", "XM", "IT", "S3M", "LZX", "ASC", "KEY", "NSDBS", "ELF", "BPL", "FDB", "XTR", "SDF", "SH", "ADF", "DMS", "AGA", "MS", "META", "README", "CFG", "RPM", "ASC", "INI", "ASM", "MD", "DLL", "SFV", "CPK", "RPT", "CAB", "URL", "CF1", "CF2", "INF", "NFO", "MQ4", "NDS", "JSP", "GG", "SWF", "PS", "RTF", "BAS", "CC", "C", "CPP", "CXX", "H", "HPP", "CS", "JAVA", "PY", "PL", "PHP", "DB", "HTM", "HTML", "ASPX", "XML", "TXT", "SQL", "CSV", "PSD", "GZ", "BIN", "LOG", "CUE", "PAR", "PAR2", "PYK", "PK3", "PK4", "SKB", "IMG", "HGZ", "AI", "OTF", "TTF", "CSS", "PLS", "Z64" };
    }
}